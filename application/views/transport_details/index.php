        ...
        <div class="col-md-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">Delivery Challan List</h3>
                <div class="box-tools">
                  <a href="<?php echo site_url('transport_details/add'); ?>" class="btn btn-primary btn-sm"> <i class="fa fa-plus"> </i>Create Delivery Challan</a>
              </div>
          </div>
          <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($t['is_deliver'] == 'N') {?>
                                        <a href="<?php echo site_url('transport_details/edit/' . $t['id']); ?>" class="btn btn-info btn-xs" style="
                                        margin-bottom: 10px;
                                        "><span class="fa fa-pencil"></span> Edit</a>

                                    <?php }?>
                                    <a href="<?php echo site_url('transport_details/diesel_print/' . $t['id']); ?>" class="btn btn-warning btn-xs" style="
                                    margin-bottom: 10px;
                                    "><span class="fa fa-print"></span> Diesel Print </a>
                                    <a href="<?php echo site_url('transport_details/view_more/' . $t['id']); ?>" class="btn btn-info btn-xs" style="
                                    margin-bottom: 10px;
                                    "><span class="fa fa-eye"></span> View </a>
                                    <a href="<?php echo site_url('transport_details/view_print/' . $t['id']); ?>" class="btn btn-info btn-xs" style="
                                    margin-bottom: 10px;
