...
<div class="row">
    <div class="col-md-12">
      ...
      <div class="box-header">
            <h3 class="box-title">Delivery Challan Edit</h3>
            </div>
            <div class="box-body">
            ...
            <div class="row">
             ...
             <div class="col-md-2">
               <label for="delivery_rate" class="control-label"> <span class="text-danger">*</span>Delivery Rate</label>
                <div class="form-group">
                  <input type="text"  required="" readonly name="delivery_rate" value="<?php echo ($this->input->post('delivery_rate') ? $this->input->post('delivery_rate') : $transport_details['chalan_rate']); ?>" class="form-control delivery" id="delivery_rate"  />
...
if ($user_type != '2') {?>
             <div class="col-md-2">
               <label for="cash_amount" class="control-label"> <span class="text-danger"></span>Cash Advance</label>
                <div class="form-group">
              <input type="number" name="cash_amount"  value="<?php echo ($this->input->post('cash_amount') ? $this->input->post('cash_amount') : $transport_details['cash_amount']); ?>" class="form-control advance" id="cash_amount" />
	...
	foreach ($diesel_transaction as $t) {
		?>
			...
			?>><?php echo $row['petrol_pumps_name']; ?></option>
             ...
             <td><input type="number" class="form-control"  id="diesel_qty<?php echo $i; ?>" value="<?php echo $t['diesel_qty'] ?>" name="diesel_qty[]" readonly></td>
             <td><input type="number" class="form-control" id="diesel_rate<?php echo $i; ?>"onkeyup="cal(0)" name="diesel_rate[]" value="<?php echo $t['diesel_rate'] ?>" readonly></td>
             <td><input type="number" class="form-control" id="diesel_amount<?php echo $i; ?>"  name="diesel_amount[]" value="<?php echo $t['diesel_amount'] ?>" readonly></td>
             <?php if ($i == '0') {?>
           ...
           <div class="row">
             ...
             <div class="col-md-3">
               <label for="delivery_proof" class="control-label"> <span class="text-danger">*</span>Delivery Proof</label>
                <div class="form-group">
                  <input type="file"  name="delivery_proof"  required class="form-control" id="delivery_proof" />
...
select: function (event, ui) {
   ...
   $("#delivery_weight").on("keyup",function(event) {

     var delivery_weight=$('#delivery_weight').val();

if(Number(delivery_weight) <1)
    {
     alert("chalan weight greater than 0" );
      $("#delivery_weight").val("");
     document.getElementById("delivery_weight").focus();
     return false;
   }
     });
