...
<table border="1" cellpadding="1" cellspacing="0" style="width:100%">
        <tbody>
                ...
                <tr>
                        ...
                        <td>&nbsp; <?php $total = $transport_details['difference_amount'] - $transport_details['total_advance'];
	...
	$diesel_amount += number_format((float) $dt['diesel_amount'], 2, '.', ''); ?></td>
      ...
      <?php $i++;}?>
                ...
                <tr>
                        ...
                        <td style="background-color:#dddddd">&nbsp; <?php $total = $transport_details['difference_amount'] - $transport_details['total_advance'];
echo number_format((float) $total, 2, '.', '');?></td>
                </tr>
                <tr>
                        <td style="width:148px">&nbsp;</td>
