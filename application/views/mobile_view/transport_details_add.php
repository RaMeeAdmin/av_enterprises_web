...
$id = $i + 1?>
       ...
       <div class="col-md-2">
         ...
         <div class="form-group">
          <input type="date"  name="date" value="<?php echo date('Y-m-d') ?>" class="has-datepicker form-control"  id="date" required="" />
  ...
  <div class="row">
           ...
           <div class="col-md-2">
             ...
             <div class="form-group">
              <input type="text" name="drivername" value="<?php echo $this->input->post('driver_name'); ?>" class="form-control " id="driverid" required="" />
             ...
             <div class="col-md-2">
               <label for="chalan_weight" class="control-label"> Chalan Weight <span class="text-danger">*</span></label>
               <div class="form-group">
                <input type="text" name="chalan_weight" value="<?php echo $this->input->post('chalan_weight'); ?>" class="form-control chalan" id="chalan_weight" required="" />
