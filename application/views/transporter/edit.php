    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <div class="box-body">
           <!--  <form id="add_name"> -->
            <?php echo form_open_multipart('transporter/edit/'.$transporter['id']); ?>
              <div class="row">
                <div class="col-md-3">
                 <label for="owner_name" class="control-label">Owner Name<span class="text-danger">*</span></label>
                 <div class="form-group">
                  <input type="text" name="owner_name"  class="form-control " id="owner_name" required="required" value="<?php echo $transporter['owner_name'] ?>" />
                </div>
              </div>
              ...
              <div class="col-md-3">
               ...
               <div class="form-group">
                <input type="text" name="contact_person_name" value="<?php echo $transporter['contact_person_name'] ?>"  class="form-control " id="contact_person_name" />
            ...
            <div class="col-md-3">
             ...
             <div class="form-group">
              <input type="text" name="contact_person_number"  value="<?php echo $transporter['contact_person_number'] ?>"  class="form-control" id="contact_person_number" />
          ...
          <div class="col-md-3">
           ...
           <div class="form-group">
             <textarea name="address" id="address" class="form-control"><?php echo $transporter['address'] ?></textarea>
           </div>
         </div>
       </div>
       <div class="row">
        <div class="col-md-3">
         ...
         <div class="form-group">
          <input type="text" name="pan_number" class="form-control " id="pan_number" value="<?php echo $transporter['pan_number'] ?>" />
        </div>
      </div>
      <div class="col-md-3">
       <label for="gst_number" class="control-label">GST Number <span class="text-danger"></span></label>
       <div class="form-group">
        <input type="text" name="gst_number" value="<?php echo $transporter['gst_number'] ?>" class="form-control" id="gst_number" />
...
<div class="col-md-12">
  <div class="table-responsive">
    <table class="table table-bordered" id="dynamic_field1">
      ...
      <tr>
       <td><input type="text" required class="form-control"  id="account_holder_name0" name="account_holder_name[]" value="<?php echo $row['account_holder_name'] ?>"></td>
       <td><input type="text" required class="form-control" id="account_number0" name="account_number[]" maxlength="25" value="<?php echo $row['account_number'] ?>"></td>
       <td><input type="text" required class="form-control" id="ifsc0"  name="ifsc[]" value="<?php echo $row['ifsc'] ?>"></td>
  ...
  <div class="table-responsive">
    <table class="table table-bordered" id="dynamic_field">
      ...
      <?php foreach ($vehicle as $row) {?>
        <tr>
         <td><input type="text" required class="form-control" value="<?php echo $row['vehicle_number'] ?>"  id="vehicle_no0" name="vehicle_no[]"></td>
         <td><input type="file" value="<?php echo $row['rc_book'] ?>"  class="form-control" id="rcbook0" name="rcbook[]">
          <?Php if($row['rc_book']!=''){ ?>
          <a href="<?php echo base_url() . 'uploads/document/'.$row['rc_book'];?>">view
          rc book</a> <?php }?></td>
         <td><input type="file" value="<?php echo $row['insurance_copy'] ?>" class="form-control" id="insurance0"  name="insurance[]">
          <?Php if($row['insurance_copy']!=''){ ?> <a href="<?php echo base_url() . 'uploads/document/'.$row['insurance_copy'];?>"> view insurance copy</a><?php }?></td>
       </tr>
     <?php }?>
   </table>
  ...
  $(document).ready(function()
  {
    ...
    $('#add').click(function(){
     $('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added">'+
       ...
       '<td><input type="file" class="form-control" id="rcbook'+i+'"  name="rcbook[]"></td><td><input type="file" id="insurance'+i+'" class="form-control"  name="insurance[]"></td>'+
